 ...
 *
 * Disassembly of SSDT-6-NVOP.aml, Mon Oct 12 18:23:25 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00004354 (17236)
 *     Revision         0x01
 *     Checksum         0x87
 *     OEM ID           "Insyde"
 *     OEM Table ID     "NVOP    "
 ...
 */
DefinitionBlock ("", "SSDT", 1, "Insyde", "NVOP    ", 0x00001000)
{
    /*
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x77F16018, 0x00040004)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (SGOP, SystemMemory, 0x75F7EF98, 0x00000045)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (NOPR, SystemMemory, 0x77F7B018, 0x00002010)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            Store (Zero, \_SB.PCI0.LPCB.EC0.GATY)
            Sleep (0x0A)
            Store (\_SB.PCI0.PEG0.LREN, \_SB.PCI0.PEG0.LTRE)
            Store (One, LNKD)
            While (LEqual (SGPI (0x00020013), One))
            {
                Sleep (One)
            }
        }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            SGPO (0x00020010, Zero)
            Store (\_SB.PCI0.PEG0.LTRE, \_SB.PCI0.PEG0.LREN)
            Sleep (0x14)
            Store (Zero, MLTF)
            Store (0x02, \_SB.PCI0.LPCB.EC0.GATY)
            Sleep (0x0A)
        ...
        Method (OGC6, 4, Serialized)
        {
            ...
            While (One)
            {
                ...
                ElseIf (LEqual (_T_0, One))
                {
                    ...
                    {
                        CreateField (JTB1, 0x0C, One, MHYB)
                        CreateField (JTB1, 0x0D, One, RPCL)
                ...
                ElseIf (LEqual (_T_0, 0x03))
                {
                    ...
                    If (LGreaterEqual (OSYS, 0x07DD))
                    {
                        ...
                        {
                            Store (ToInteger (DFGC), \_SB.PCI0.PEG0.PEGP.TDGC)
                            Store (ToInteger (GPCX), \_SB.PCI0.PEG0.PEGP.DGCX)
                        }
                    }
