 ...
 *
 * Disassembly of SSDT-0-CB-01.aml, Mon Oct 12 18:23:24 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00005104 (20740)
 *     Revision         0x02
 *     Checksum         0xEB
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
     ...
     * disassembly, but only 23 were resolved (2 unresolved). Additional
    ...
    External (_SB_.PCI0.PEG0.WKEN, IntObj)
    ...
    OperationRegion (SANV, SystemMemory, 0x77F74D98, 0x0104)
